...
import com.guseyn.migrator.migration.MigrationSegment;
...
public class CleanJavaCode {
	...
	public List<MigrationSegment> listOfCleanedFiles(String path, List<String> diffsFilePath) throws IOException, InterruptedException {
		...
		for (String diffPath : diffsFilePath) {
			...
			System.out.println("Start Cleanning FileCookBook:" + diffPath);
	...
	public List<MigrationSegment> listOfCleanedMigrationSegments(String diffFilePath) throws InterruptedException, IOException {
        ...
        if (fileWithoutJavaCode.length() > 0) {
            ...
            fr.write(fileWithoutJavaCode.toString()); // Warning: this will REPLACE your old file contentFromResources!
            fr.close();
            System.out.println("Complete Clean Up FileCookBook successfully\n");
        } else {
            ...
            System.err.println("Delete FileCookBook because it dosenot have migration");
