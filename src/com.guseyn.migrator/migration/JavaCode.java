...
public class JavaCode {
    ...
    public static List<MigrationSegment> getListOfCleanedFiles(List<String> diffsFilePath) throws IOException, InterruptedException {
        ...
        for (String diffPath : diffsFilePath) {
            ...
            List<MigrationSegment> listOfblocks = startCleaning(diffPath);
    ...
    public static List<MigrationSegment> startCleaning(String diffFilePath) throws IOException, InterruptedException {
        List<MigrationSegment> listOfBlocks = getBlocksList(diffFilePath);
        ...
        if (fileWithoutJavaCode.length() > 0) {
            ...
            // Apply algorithms on the functions
            ...
            System.err.println("Delete File because it does not have migration");

            // delete dir if there is no files there
    ...
    public static List<MigrationSegment> getBlocksList(String diffFilePath) {
